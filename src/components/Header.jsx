    ...
    <header className="sticky top-0 z-40 px-6 md:px-8 py-4 bg-glassDark/60 backdrop-blur-md border-b border-white/10">
      <div className="max-w-6xl mx-auto flex items-center justify-between gap-4">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm">
          ...
          <Link to="/mylist" className="text-white/90 hover:text-glassPink">My List</Link>
        </nav>
        ...
        <div className="flex items-center gap-4 relative">
          ...
          {!user ? (
            ...
            <div className="relative">
              ...
              >
                <img
                  src={user.user_metadata?.avatar_url || "https://api.dicebear.com/7.x/avataaars/svg?seed=glassUser"}
                  alt="avatar"
